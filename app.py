...
# ==========================================
# 1. إعدادات المنصة وقاعدة البيانات السيادية
# ==========================================
...
# ==========================================
# 3. القاموس المنهجي العلمي (المسارات الـ 25 كاملة)
# ==========================================
methodology_db = {
    ...
    "مسار الأثر والتقييم (Kirkpatrick)": {
        ...
        "تقرير قياس العائد (SROI)": [("إجمالي الاستثمارات:", "مدخلات مالية"), ("خارطة التغير:", "كيف حدث التغير؟"), ("ترجمة الأثر لقيمة:", "وكلاء ماليون"), ("تحليل الاستنزاف:", "بدون تدخلنا"), ("نسبة العائد الاجتماعي:", "القيمة مقابل الدولار"), ("تحليل الإسناد:", "دورنا حصراً"), ("مدة دوام الأثر:", "انخفاض القيمة"), ("المنافع البيئية:", "آثار غير مباشرة"), ("صحة وموثوقية البيانات:", "تحليل الشفافية"), ("توصيات تعظيم الأثر:", "زيادة القيمة")],
    ...
    "مسار الاستراتيجية والمخاطر": {
        ...
        "تقرير تقييم الجاهزية": [("هدف التحول:", "ما الذي سنغيره؟"), ("جاهزية التكنولوجيا:", "الأنظمة والأجهزة"), ("كفاءة الكادر البشري:", "مهارات التغيير"), ("الاستقرار المالي:", "ميزانية التحول"), ("دعم القيادة العليا:", "مدى الالتزام"), ("مقاومة التغيير:", "المعوقات النفسية"), ("وضوح اللوائح:", "دعم القوانين"), ("مخاطر الفشل:", "أسباب التعثر"), ("مستوى النضج الرقمي:", "تقييم 1-5"), ("قرار الجاهزية:", "خطة الإطلاق")]
    },
    "مسار العمليات والإنتاجية": {
        "تقرير الإنجاز الدوري": [("المستهدفات:", "الأهداف الرقمية"), ("الإنجاز الفعلي:", "المنفذ فعلياً"), ("أسباب الهدر الزمني:", "لماذا تأخرنا؟"), ("كفاءة الموازنة:", "الصرف مقابل الإنجاز"), ("جودة المخرجات:", "المطابقة للمواصفات"), ("العوائق البيروقراطية:", "مشاكل الموافقات"), ("إنتاجية الفريق:", "أداء الموظفين"), ("تحديثات سلاسل الإمداد:", "وصول المواد"), ("الاحتياجات اللوجستية:", "المتطلبات القادمة"), ("خطة التصحيح:", "تدارك التأخير")],
        "تقرير تحليل الهدر": [("تصنيف (TIMWOODS):", "انتظار، نقل، عيوب"), ("موقع الهدر:", "القسم المحدد"), ("حجم الخسارة:", "تقدير الكلفة"), ("السبب الجذري:", "لماذا يحدث؟"), ("تأثير الهدر:", "تأخر العميل"), ("إجراء كايزن:", "مقترح الإزالة"), ("كلفة التحسين:", "الاستثمار المطلوب"), ("مقاومة التغيير:", "تحديات التطبيق"), ("النتيجة المتوقعة:", "الوفر المضاف"), ("المسؤول عن التنفيذ:", "تحديد المعني")],
        "تقرير أداء الموردين": [("اسم المورد:", "الجهة المختارة"), ("الالتزام بالمواعيد:", "دقة التوريد"), ("مطابقة الجودة:", "جودة المنتجات"), ("التنافسية السعرية:", "الأسعار مقابل السوق"), ("المرونة في التعامل:", "الطلبات الطارئة"), ("خدمات ما بعد البيع:", "الضمان والصيانة"), ("الوضع المالي:", "استقرار المورد"), ("سجل النزاعات:", "مشاكل سابقة"), ("مخاطر الاعتماد:", "احتکار أو ندرة"), ("القرار التعاقدي:", "تجديد أو استبعاد")],
        ...
        "تقرير مؤشرات (KPIs)": [("القسم المستهدف:", "نطاق القياس"), ("مؤشر زمن التنفيذ:", "المستهدف مقابل المحقق"), ("تكلفة المخرج الواحد:", "الصرف المعياري"), ("مؤشر جودة المخرجات:", "نسبة الإتقان"), ("تحليل أسباب التدني:", "لماذا لم نحقق؟"), ("المنجزات الاستثنائية:", "نجاحات خاصة"), ("كفاءة القيادة:", "الإدارة والتحفيز"), ("المقارنة بالعام:", "اتجاه الأداء"), ("تحديث المستهدفات:", "الأهداف الطموحة"), ("القرارات الناتجة:", "بناءً على القياس")]
    },
    "مسار العلاقات وصورة المؤسسة": {
        ...
        "تقرير إدارة الفعاليات": [("نوع الفعالية:", "الهدف منها"), ("التنظيم اللوجستي:", "قاعات وضيافة"), ("تطبيق البروتوكول:", "الرسميات والتشريفات"), ("كفاءة إدارة الوقت:", "الالتزام بالجدول"), ("جودة المتحدثين:", "تقييم المحتوى"), ("التغطية الإعلامية:", "البث والتوثيق"), ("تفاعل الحضور:", "المناقشات والأسئلة"), ("المشاكل التقنية:", "سرعة حل الأعطال"), ("التقييم المالي:", "ضمن الميزانية"), ("الدروس المستفادة:", "تحسينات قادمة")],
...
# ==========================================
# 4. منطق التكيف مع محركات جوجل (حل خطأ 404/400)
# ==========================================
...
def platform_page():
    ...
    if st.session_state.step == 1:
        ...
        if st.button("التالي: التحليل الاستراتيجي ⬅️", key="n1"): st.session_state.step = 2; st.rerun()
        ...
        if st.button("التالي: صناعة القرار ⬅️", key="n2"): st.session_state.step = 3; st.rerun()
        if st.button("➡️ رجوع للمرحلة السابقة", key="p2"): st.session_state.step = 1; st.rerun()
        ...
        if st.button("اعتماد وتوليد الوثيقة السيادية 📄", key="gen_btn"):
            if balance <= 0: st.error("⚠️ الرصيد صفر.")
            else:
                try:
                    genai.configure(api_key=st.secrets["GEMINI_API_KEY"])
                    
                    # 💡 الحل العبقري: البحث عن محرك متاح فعلياً في حسابك
                    ...
                    for target in ['models/gemini-1.5-flash', 'models/gemini-1.5-pro', 'models/gemini-pro']:
                        if target in available_models:
                            ...
                            break
                    if not selected_model: selected_model = available_models[0] # اختيار أول متاح كحل أخير

                    model = genai.GenerativeModel(selected_model)
                    
                    data_feed = "".join([f"- {q}: {get_draft(f'q_{report_type}_{i}')}\n" for i, (q, _) in enumerate(questions)])
                    
                    prompt = f"بصفتك مستشار استراتيجي سيادي، صغ تقريراً استشارياً احترافياً لـ '{report_type}' لجهة '{org}' مشروع '{proj}'. البيانات الميدانية: {data_feed}. التوصيات: {recs}. اللغة: رسمية جداً، رصينة، نقاط مباشرة (تشخيص، فجوات، مخاطر، قرارات)."
                    
                    with st.spinner(f"جاري الصياغة عبر المحرك المتاح ({selected_model})..."):
        ...
        if st.button("➡️ رجوع للمرحلة السابقة", key="p3"): st.session_state.step = 2; st.rerun()
    ...
    if st.session_state.report_preview:
        ...
        bio = io.BytesIO()
        doc.save(bio)
        st.download_button("⬇️ تحميل بصيغة Word", bio.getvalue(), file_name=f"{proj}.docx", key="dl_btn")
